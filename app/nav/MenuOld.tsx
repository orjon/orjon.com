...
const buttonBaseStyle =
  'relative group w-full bg-[linear-gradient(to_bottom,var(--titleBar)_50%,var(--menuBottom)_50%)] shadow-[inset_0px_-1px_2px_0px_var(--menuShadow)]'
const buttonStyle =
...
const MenuOld = () => {
  ...
  return (
    ...
    <div className='hidden md:flex text-lg font-medium text-menuText'>
      ...
      <div className='max-content-width w-full flex b-red'>
        {menu}
        <div className={`${buttonBaseStyle} w-full`}>
          <div className='absolute z-0 bg-titleBar w-full h-1/2'></div>
          <div className={`relative z-10 ${buttonStyle} w-full rounded-r-none`}>
            &nbsp;
          </div>
        </div>
      ...
      <div className={`${buttonBaseStyle} w-full flex `}>
        <div className='absolute z-0 bg-titleBar w-full h-1/2'></div>
